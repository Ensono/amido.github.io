...
function DotNetCoreLogo(props) {
  return (
    ...
    >
      <defs>
        <style>{".prefix__cls-3{fill:#fff}.prefix__cls-4{fill:#f2f2f2}"}</style>
      </defs>
