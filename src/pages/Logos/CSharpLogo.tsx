...
function CSharpLogo(props) {
    return (
        ...
        />
        <g aria-label="\u266F" data-name="\u266F" fill="#fff">
            <path d="M326 213h12.5l-8.541 82.5h-12.735zM352.776 213h12.5l-8.541 82.5H344z" />
            <path d="M312 232.592h62.5v12.072H312zM308.5 262H371v12.072h-62.5z" />
        </g>
        </svg>
    );
};
