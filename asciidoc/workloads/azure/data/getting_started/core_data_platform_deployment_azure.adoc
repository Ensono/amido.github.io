...
* If you want to provision infrastructure within a link:../infrastructure_data_azure.adoc#networking[private network], ensure this variable is set to `true`.
