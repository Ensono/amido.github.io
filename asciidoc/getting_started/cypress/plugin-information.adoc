...
:keywords: Nx, monorepo, stacks, ensono, cypress, generator, executor
...
[NOTE]
====
Visit the link:../../testing/testing_in_nx/frontend_testing_in_nx.md[Frontend Testing in an Nx monorepo] and link:../../testing/testing_in_nx/cypress_nx.md[Testing with Cypress] user guides for more information!
====
