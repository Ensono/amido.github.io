...
5. Make sure that the Enable Private Networks box is set to your preffered deployment method. If you want to provision infrastructure within a link:[private network](../architecture/infrastructure_data_azure#networking), ensure this variable is ticked. Unticking the box will issue a public network deployment.
