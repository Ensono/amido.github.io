...
This section provides an overview of scaffolding and generating a new Data Platform project using the [Stacks CLI](/docs/stackscli/about).
...
Download and install the [Stacks CLI](/docs/stackscli/about).
