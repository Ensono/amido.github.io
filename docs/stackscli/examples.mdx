...
To create a Stacks Nx Project with the Next.js App preconfigured start by running the interactive command.
...
To create an empty Stacks Nx Project start by running the interactive command.
