...
Please see the [.NET WebApi project using the interactive command](./examples#net-webapi-project-using-the-interactive-command) section for an example of how this command can be used.
...
The [Examples](./examples) section has a lot of examples showing how to run the Ensono Stacks CLI, the following show some simple uses of the command.
