...
| Features | Automatic waiting In browser Element selector tool Spies, stubs , clocks Real time reloads Can use the same environment variables as the webapp | WebDriver | WebDriver Multi-thread test execution Enhanced reporting | Render |
